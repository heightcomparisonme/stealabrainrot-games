...
export default function TrendingPage() {
  ...
  const trendingGames = useMemo(() => {
    return games.filter(game => game.trending || game.featured || game.popular)
      .sort((a, b) => {
        // Prioritize trending, then featured and popular
        ...
        <section className="hero-gradient py-16">
          <div className="container-custom text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Discover what’s hot right now! These games are rapidly gaining popularity and loved by more players every day.
              Be the first to try the next big hit and lead the trend!
            </p>
          ...
          <div className="container-custom">
            <div className="flex items-center justify-between mb-6">
              <h2 className="section-title">
                {hasActiveFilters ? '🔍 Filtered Results' : '📈 Trending Games'}
        ...
        <section className="py-16 bg-card">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-foreground mb-6">Trending by Category</h2>
              ...
              <p className="text-muted-foreground">
                These categories are currently the most popular with fast-growing game counts and player engagement.
                Follow these trends to discover genres you might love!
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-4 gap-6 mb-8">
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="text-muted-foreground">Currently trending</div>
                </div>
                <div className="bg-card border border-border rounded-lg p-6">
                  <div className="text-3xl font-bold text-secondary mb-2">
                    {trendingGames.filter(g => g.featured).length}
                  </div>
                  <div className="text-muted-foreground">Editor’s picks</div>
                </div>
                <div className="bg-card border border-border rounded-lg p-6">
              ...
              <p className="text-muted-foreground">
                Our algorithms continuously analyze user behavior and game data to update trends in real time.
                New games join the trending list every day — stay tuned so you don’t miss out!
              </p>
            </div>
          </div>
        </section>
